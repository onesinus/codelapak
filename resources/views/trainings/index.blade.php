                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <form method="GET" action="{{ url('trainings') }}" accept-charset="UTF-8" role="search">
                                    <input type="text" class="form-control mt-2 mb-2" name="search" value="{{ request('search') }}" placeholder="Search Training or Scroll down to search manually..." autocomplete="off">
                                </form>
                            </div>
                                ...
                                <div style="height: 425px; overflow-y: scroll;" class="row">
                                    ...
                                    <div class="card col-md-4" style="margin-bottom: 3%;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <button id_training="{{$t->id}}" price="{{$t->price}}" class="btn btn-success take">Take Training</button>
                                            <a href="trainings/{{$t->id}}" class="btn btn-primary">Detail</a>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                                <div style="margin-left: 49%; background-color: white;"> {!! $trainings->appends(['search' => Request::get('search')])->render() !!} </div>
                            </div>
                        </div>
                    </div>
                </div>
